...
Document.Create(document =>
{
    document.Page(page =>
    {
        ...
        // page content
        //page.Header().Height(100).Background(Colors.Blue.Medium); // -> El encabezado
        //page.Content().Background(Colors.Yellow.Medium); // -> Contenido
        //page.Footer().Height(50).Background(Colors.Red.Medium); // -> Pie de página

        page.Header().ShowOnce().Row(row =>
        {
            // Un Primer "item" |  row.ConstantItem(50). -> configuramos el ancho PERSONALIZADO.
            row.ConstantItem(140).Height(60).Placeholder(); // Placeholder() -> img. 
